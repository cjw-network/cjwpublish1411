 ...
 *  // ###JAC_PATCH_G_52_EZ_2014.11### /content/treemenu throws PHP notices with nginx
...
class eZSys
{
    ...
    public static function cacheDirectory()
    {
        ...
        {
            // ###JAC_PATCH_G_44_EZ_2014.11### separate var_log and var_cache project folders
            if ( defined( 'JAC_PATCH_USE_EXTRA_FOLDER_VAR_CACHE' ) && JAC_PATCH_USE_EXTRA_FOLDER_VAR_CACHE === true )
            {
                // use separate cache folder from ez root use projectsettings from var folder
                //   /var_cache/projectname ....  /var/projectname/storage   /var/projectname/log
