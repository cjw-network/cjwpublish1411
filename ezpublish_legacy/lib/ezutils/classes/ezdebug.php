...
/**
 *
    ###JAC_PATCH_G_03_EZ_2014.11###
    - lib/ezutils/classes/debug.php:
    - settings/site.ini
    ------------------------------
    http://issues.ez.no/IssueView.php?Id=12522
    - store are logfiles in dir specified in site.ini
    - patch / setting can be enabled/disabled in site.ini
    ...
    ###JAC_PATCH_G_44_EZ_2014.11### separate var_log and var_cache project folders

    ###JAC_PATCH_G_53_EZ_2014.11###  DebugByIP not working
 *
 *
...
-->
    ...
    */
    ...
    {
        // ###JAC_PATCH_G_44_EZ_2014.11### separate var_log and var_cache project folders
        if ( defined( 'JAC_PATCH_USE_EXTRA_FOLDER_VAR_LOG' ) && JAC_PATCH_USE_EXTRA_FOLDER_VAR_LOG === true )
        {
            $logDir = str_replace( 'var/', 'var_log/', $logDir );
        }
        $this->LogFiles = array( self::LEVEL_NOTICE  => array( $logDir, 'notice.log' ),
