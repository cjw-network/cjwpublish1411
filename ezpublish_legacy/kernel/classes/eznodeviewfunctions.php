<?php
// ###JAC_PATCH_G_56_EZ_2014.11### view cache file written when cache_ttl=0 is set in template
/**
...
//        $contents = $cacheFile->fetchContents();
    ...
    static public function contentViewGenerate( $file, $args )
    {
        ...
        // ###JAC_PATCH_G_56_EZ_2014.11### -  by setting cache_ttl to 0  in tpl code no cachfile should be generated
